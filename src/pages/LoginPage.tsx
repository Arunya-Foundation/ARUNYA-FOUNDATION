...
export const LoginPage = () => {
    ...
    if (user) {
        return (
            <div style={{
                ...
                {/* Decorative orbs */}
                <div style={{ position: 'absolute', width: 400, height: 400, borderRadius: '50%', background: 'radial-gradient(circle, rgba(18,60,115,0.08) 0%, transparent 70%)', top: '-10%', right: '-5%' }} />
                ...
                <motion.div
                    ...
                    style={{
                        ...
                        borderRadius: 32, boxShadow: '0 24px 48px rgba(11,31,58,0.08)',
                    }}
                >
                    <div style={{
                        width: 72, height: 72, borderRadius: '50%',
                        background: 'linear-gradient(135deg, #123C73, #0B1F3A)',
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                        margin: '0 auto 1.5rem',
                        boxShadow: '0 0 40px rgba(18,60,115,0.2)',
                    }}>
                        {user.photoURL ? (
                    ...
                    <h1 style={{ color: '#0B1F3A', fontSize: '1.75rem', fontWeight: 700, marginBottom: '0.5rem', fontFamily: 'Poppins, Inter, sans-serif' }}>
    ...
    return (
        <div style={{
            ...
            {/* Decorative orbs */}
            <div style={{ position: 'absolute', width: 500, height: 500, borderRadius: '50%', background: 'radial-gradient(circle, rgba(18,60,115,0.08) 0%, transparent 70%)', top: '-15%', right: '-10%', animation: 'float1 8s ease-in-out infinite' }} />
            ...
            <div style={{ position: 'absolute', width: 250, height: 250, borderRadius: '50%', background: 'radial-gradient(circle, rgba(18,60,115,0.05) 0%, transparent 70%)', top: '40%', left: '20%', animation: 'float1 6s ease-in-out infinite reverse' }} />
            ...
            <motion.button
                ...
                style={{
                    ...
                    borderRadius: '50%', border: '1px solid rgba(11,31,58,0.1)',
                    background: 'rgba(255,255,255,0.8)', backdropFilter: 'blur(12px)',
                    color: '#0B1F3A', fontSize: '1.5rem', cursor: 'pointer',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
            ...
            <motion.div
                ...
                style={{
                    ...
                    border: '1px solid rgba(11,31,58,0.08)',
                    borderRadius: 32, boxShadow: '0 32px 64px rgba(11,31,58,0.08)',
                }}
            >
                {/* Logo */}
                ...
                {/* Info text */}
                <div style={{ marginTop: '2rem', padding: '1.25rem', borderRadius: 16, background: '#eef4fb', border: '1px solid rgba(18,60,115,0.08)' }}>
                    <p style={{ color: '#0B1F3A', fontSize: '0.85rem', fontWeight: 600, marginBottom: '0.5rem' }}>
                        Why sign in?
                    </p>
                ...
                <p style={{ color: '#9ca3af', fontSize: '0.75rem', lineHeight: 1.6, marginTop: '1.5rem', textAlign: 'center' }}>
                    By signing in, you agree to the <a href="#" style={{ color: '#123C73', textDecoration: 'underline' }}>Arunya Terms</a> and <a href="#" style={{ color: '#123C73', textDecoration: 'underline' }}>Privacy Policy</a>.
                </p>
            </motion.div>
